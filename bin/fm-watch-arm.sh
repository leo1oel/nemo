...
# the harness's own tracked background task (e.g. run_in_background). Run it as its
# own standalone background task, never bundled onto the tail of another command.
