...
# state/ comes from the active home (FM_HOME / FM_STATE_OVERRIDE), so a secondmate's
# pr-check writes to its own home rather than the primary's. Matches fm-watch.sh etc.
